        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5">
              ...
              {config.social.zalo && (
                <a href={config.social.zalo} target="_blank" rel="noopener noreferrer" aria-label="Zalo"
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-white/45 text-[13px]">{config.workingHours}</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <a href={`mailto:${config.email}`} className="text-white/45 text-[13px] hover:text-primary transition-colors">
                  {config.email}
                </a>
              </li>
            </ul>
      ...
      <div className="border-t border-white/10 bg-accent-900">
        <div className="site-container py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-white/30 text-xs text-center sm:text-left">
            © {currentYear} {config.name}. All rights reserved. MSDN: {config.businessNumber}
          </p>
